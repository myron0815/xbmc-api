...
public final class PVR {
	...
	public static class GetBroadcastDetails extends AbstractCall<PVRModel.BroadcastDetail> {
		 ...
		 * Retrieves the details of a specific broadcast.
		 * @param broadcastid 
		 * @param properties  One or more of: <tt>title</tt>, <tt>plot</tt>, <tt>plotoutline</tt>, <tt>starttime</tt>, <tt>endtime</tt>, <tt>runtime</tt>, <tt>progress</tt>, <tt>progresspercentage</tt>, <tt>genre</tt>, <tt>episodename</tt>, <tt>episodenum</tt>, <tt>episodepart</tt>, <tt>firstaired</tt>, <tt>hastimer</tt>, <tt>isactive</tt>, <tt>parentalrating</tt>, <tt>wasactive</tt>, <tt>thumbnail</tt>, <tt>rating</tt>. See constants at {@link PVRModel.BroadcastFields}.
		 */
	...
	public static class GetChannelDetails extends AbstractCall<PVRModel.ChannelDetail> {
		 ...
		 * Retrieves the details of a specific channel.
		 * @param channelid 
		 * @param properties  One or more of: <tt>thumbnail</tt>, <tt>channeltype</tt>, <tt>hidden</tt>, <tt>locked</tt>, <tt>channel</tt>, <tt>lastplayed</tt>, <tt>broadcastnow</tt>, <tt>broadcastnext</tt>. See constants at {@link PVRModel.ChannelFields}.
		 */
	...
	public static class GetChannelGroupDetails extends AbstractCall<PVRModel.ChannelGroupExtendedDetail> {
		...
		public static class Channel extends AbstractModel {
			...
			/**
			 * @param limits
			 * @param properties One or more of: <tt>thumbnail</tt>, <tt>channeltype</tt>, <tt>hidden</tt>, <tt>locked</tt>, <tt>channel</tt>, <tt>lastplayed</tt>, <tt>broadcastnow</tt>, <tt>broadcastnext</tt>. See constants at {@link PVR.Channel.Property}.
			 */
			...
			public interface Property {
				...
				public final static Set<String> values = new HashSet<String>(Arrays.asList(THUMBNAIL, CHANNELTYPE, HIDDEN, LOCKED, CHANNEL, LASTPLAYED, BROADCASTNOW, BROADCASTNEXT));
			}
		}
	}
	...
	public static class GetRecordingDetails extends AbstractCall<PVRModel.RecordingDetail> {
		 ...
		 * Retrieves the details of a specific recording.
		 * @param recordingid 
		 * @param properties  One or more of: <tt>title</tt>, <tt>plot</tt>, <tt>plotoutline</tt>, <tt>genre</tt>, <tt>playcount</tt>, <tt>resume</tt>, <tt>channel</tt>, <tt>starttime</tt>, <tt>endtime</tt>, <tt>runtime</tt>, <tt>lifetime</tt>, <tt>icon</tt>, <tt>art</tt>, <tt>streamurl</tt>, <tt>file</tt>, <tt>directory</tt>. See constants at {@link PVRModel.RecordingFields}.
		 */
	...
	public static class GetTimerDetails extends AbstractCall<PVRModel.TimerDetail> {
		 ...
		 * Retrieves the details of a specific timer.
		 * @param timerid 
		 * @param properties  One or more of: <tt>title</tt>, <tt>summary</tt>, <tt>channelid</tt>, <tt>isradio</tt>, <tt>repeating</tt>, <tt>starttime</tt>, <tt>endtime</tt>, <tt>runtime</tt>, <tt>lifetime</tt>, <tt>firstday</tt>, <tt>weekdays</tt>, <tt>priority</tt>, <tt>startmargin</tt>, <tt>endmargin</tt>, <tt>state</tt>, <tt>file</tt>, <tt>directory</tt>. See constants at {@link PVRModel.TimerFields}.
		 */
