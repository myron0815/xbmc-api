...
public final class PVRModel {
	...
	public static class BroadcastDetail extends ItemModel.BaseDetail {
		 ...
		 * @param node JSON object representing a BroadcastDetail object
		 */
	...
	public static class RecordingDetail extends ItemModel.BaseDetail {
		...
		/**
		 * Construct from JSON object.
		 * @param node JSON object representing a RecordingDetail object
		 */
	...
	public static class TimerDetail extends ItemModel.BaseDetail {
		...
		/**
		 * Construct from JSON object.
		 * @param node JSON object representing a TimerDetail object
		 */
		...
		public interface State {
			...
			public final static Set<String> values = new HashSet<String>(Arrays.asList(UNKNOWN, NEW, SCHEDULED, RECORDING, COMPLETED, ABORTED, CANCELLED, CONFLICT_OK, CONFLICT_NOTOK, ERROR));
		}
	...
	public interface BroadcastFields {
		...
		public final static Set<String> values = new HashSet<String>(Arrays.asList(TITLE, PLOT, PLOTOUTLINE, STARTTIME, ENDTIME, RUNTIME, PROGRESS, PROGRESSPERCENTAGE, GENRE, EPISODENAME, EPISODENUM, EPISODEPART, FIRSTAIRED, HASTIMER, ISACTIVE, PARENTALRATING, WASACTIVE, THUMBNAIL, RATING));
	}
	...
	public interface RecordingFields {
		...
		public final static Set<String> values = new HashSet<String>(Arrays.asList(TITLE, PLOT, PLOTOUTLINE, GENRE, PLAYCOUNT, RESUME, CHANNEL, STARTTIME, ENDTIME, RUNTIME, LIFETIME, ICON, ART, STREAMURL, FILE, DIRECTORY));
	}
	...
	public interface TimerFields {
		...
		public final static Set<String> values = new HashSet<String>(Arrays.asList(TITLE, SUMMARY, CHANNELID, ISRADIO, REPEATING, STARTTIME, ENDTIME, RUNTIME, LIFETIME, FIRSTDAY, WEEKDAYS, PRIORITY, STARTMARGIN, ENDMARGIN, STATE, FILE, DIRECTORY));
	}
